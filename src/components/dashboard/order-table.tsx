const OrderTable = () => {
    return (
        ...
        <div className="flex flex-col ">
            <div
                className="relative flex  h-[430px] w-full flex-col rounded-[10px] border-[1px] border-gray-200 bg-white bg-clip-border shadow-md shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none"
            >
                <div
                            ...
                            <tr role="row">
                                ...
                                <td className="py-3 text-sm" role="cell">
                                    <div className="mx-2 flex font-bold">
                                        ...
                                        >
                                            <div
                                                className="flex w-[30%] h-full items-center justify-center rounded-md bg-brand-500 dark:bg-brand-400"
                            ...
                            <tr role="row">
                                ...
                                <td className="py-3 text-sm" role="cell">
                                    <div className="mx-2 flex font-bold">
                                        ...
                                        >
                                            <div
                                                className="flex h-full w-[30%] items-center justify-center rounded-md bg-brand-500 dark:bg-brand-400"
