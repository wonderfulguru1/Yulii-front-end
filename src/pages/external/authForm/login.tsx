            ...
            <div className='flex gap-10 lg:flex-row flex-col lg:items-center justify-between'>
                <div className='lg:w-1/2'>
                    ...
                    {/* <div className="text-sm flex flex-col items-center py-4"> */}
                        <Button onClick={signInWithGoogle} className="flex hover:bg-transparent items-center justify-center space-x-2 text-gray-600 my-2 w-1/2 py-2 border border-gray-200 rounded">
