...
const Download = () => {
  return (
    ...
    <div className="w-1/2 ">
      <h1 className="text-6xl py-8 font-semi-bold">Ready to start selling? We can help!</h1>
      <p className="text-xl"> Our app is user friendly, convenient and helps  you 
      showcase you good and product to a wider audience, download
      our app now and get started in minutes!</p>
